...
function formatMajorNav(array, container) {
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        majorLink.addEventListener('click', function () {
            ...
            let majorInfo = document.createElement("P");
            majorInfo.innerHTML = 'The Major Arcana is comprised of 22 cards in a single suit. They are used as \"trump\" cards, meaning they outrank cards of the Minor Arcana suits. The Major Arcana cards usually indicate a major event or change in a person\'s life. This makes sense considering the fact that Minor Arcana cards outnumber Major Arcana by more than two to one. So when you pull a Major Arcana card, you should view it as a sign of something larger taking place in your life.';
            cardContainer.appendChild(majorInfo);
...
function formatWandsNav(array, container) {
    for (let i = 0; i < array.length; i++) {
        ...
        wandsLink.addEventListener('click', function () {
            cardContainer.innerHTML = '';
            let wandsInfo = document.createElement("P");
            wandsInfo.innerHTML = 'This suit, most often called "Wands" and sometimes called "Rods" or "Staves," represents initiative, ambition, drive and desire. This is the suit of enterprise and risk-taking.';
            cardContainer.appendChild(wandsInfo);
            formatCard(array[i], cardContainer);
        })
        container.appendChild(wandsLink);
    }
}
...
function formatCupsNav(array, container) {
    for (let i = 0; i < array.length; i++) {
        ...
        cupsLink.addEventListener('click', function () {
            cardContainer.innerHTML = '';
            let cupsInfo = document.createElement("P");
            cupsInfo.innerHTML = 'The suit in Tarot known as Cups is also referred to as Chalices or Hearts. It represents the emotional and psychic aspects of life -- fantasy, imagination, feelings, love.';
            cardContainer.appendChild(cupsInfo);
            formatCard(array[i], cardContainer);
        })
        container.appendChild(cupsLink);
    }
}
...
function formatSwordsNav(array, container) {
    for (let i = 0; i < array.length; i++) {
        ...
        swordsLink.addEventListener('click', function () {
            cardContainer.innerHTML = '';
            let swordsInfo = document.createElement("P");
            swordsInfo.innerHTML = 'This suit represents the rational mind and its ability to discriminate. Swords cut through things in order to pierce illusion, to differentiate between fantasy and reality.';
            cardContainer.appendChild(swordsInfo);
            formatCard(array[i], cardContainer);
        })
        container.appendChild(swordsLink);
    }
}
...
function formatPentaclesNav(array, container) {
    for (let i = 0; i < array.length; i++) {
        ...
        pentaclesLink.addEventListener('click', function () {
            cardContainer.innerHTML = '';
            let pentaclesInfo = document.createElement("P");
            pentaclesInfo.innerHTML = 'This suit, most often named "Coins" or "Pentacles", is a symbol for a magical talisman that represented wealth or potential. This suit represents something supportive that is available to you -- whether it be health, some kind of talent, a material or financial resource.';
            cardContainer.appendChild(pentaclesInfo);
            formatCard(array[i], cardContainer);
        })
        container.appendChild(pentaclesLink);
    }
}
